...
/**
 * Comparator class to compare tokens based on least to greatest frequency and alphabetically
 */
public class CompLeastToken implements Comparator<Token> {
    /**
    ...
    public int compare(Token o1, Token o2) {
        ...
        int frequencyResult = (o1.getFrequency() - o2.getFrequency());
